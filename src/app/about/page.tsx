...
export async function generateMetadata() {
  return getBaseMetadataAction({
    ...
    description:
      "ShinaMix — компанія з більш ніж 24 річним досвідом у продажу автошин. Ми працюємо лише з перевіреними брендами, гарантуємо якість, чесні ціни та швидку доставку по всій Україні. Ми цінуємо довіру клієнтів і пропонуємо тільки якісні шини.",
    openGraph: {
