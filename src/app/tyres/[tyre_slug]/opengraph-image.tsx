    ...
    return new ImageResponse(
        (
            <div style={{
                width: "100%", height: "100%", background: BG, color: FG,
                fontFamily: "Karla, system-ui, sans-serif",
                display: "flex", flexDirection: "row", padding: 40, gap: 40
            }}>
                {/* Фото */}
                <div style={{
                    flex: 1,            
                ...
                <div style={{ display: "flex", flexDirection: "column", flex: 1}}>
                    ...
                    <div style={{ marginTop: 8, fontSize: 48, fontWeight: 500, opacity: .65 }}>
                        {tyreSeason}
                    </div>

                    {tyreSize && (
                        <div style={{ marginTop: 8, fontSize: 48, fontWeight: 600, opacity: .85 }}>
                            {tyreSize}
                        </div>
                    )}
       
                    <div style={{ marginTop: 24, width: 240, height: 4, background: "rgba(0,0,0,.12)" }} />
                    ...
                    >
                        <span style={{ fontSize: 72, fontWeight: 800, lineHeight: 1 }}>
                            {String(tyrePrice.toLocaleString("uk-UA"))}
                        </span>
                        <span style={{ marginLeft: 12, fontSize: 48, fontWeight: 600, opacity: 0.85 }}>
                            грн/шт
                        </span>
                    </div>
